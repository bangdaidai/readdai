...
import io.legado.app.help.ai.AiInitializer
...
class App : Application() {
    ...
    override fun onCreate() {
        ...
        // 初始化AI功能
        AiInitializer.init(this)
        
        // 初始化AI日志系统
        io.legado.app.help.ai.AiLogManager.init(this)
...
//            ThemeConfig.clearBg() //每次手动切换主题时清理多余图片
            ...
            //初始化阅读状态分组
            ReadingStatusGroupHelper.initReadingStatusGroups()
            //批量更新所有书籍的阅读状态
            ReadingProgressHelper.updateAllBooksReadingStatus()
            //批量更新所有书籍的阅读状态分组
            ReadingStatusGroupHelper.updateAllBooksGroupByReadingStatus()
            // 执行阅读数据一致性检查已简化，不再需要
        }
    }
