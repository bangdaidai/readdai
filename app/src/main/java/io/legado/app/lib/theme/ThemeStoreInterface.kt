...
internal interface ThemeStoreInterface {
    ...
    fun textColorOther(@ColorInt color: Int): ThemeStore

    fun textColorOtherRes(@ColorRes colorRes: Int): ThemeStore

    fun textColorOtherAttr(@AttrRes colorAttr: Int): ThemeStore
    ...
    fun backgroundCard(@ColorInt color: Int): ThemeStore

    fun dividerColor(@ColorInt color: Int): ThemeStore
