...
object AppConfig : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    val immNavigationBar: Boolean
        get() = appCtx.getPrefBoolean(PreferKey.immNavigationBar, false)
    ...
    var showBookCard: Boolean
        get() = appCtx.getPrefBoolean(PreferKey.showBookCard, true)
        set(value) {
            appCtx.putPrefBoolean(PreferKey.showBookCard, value)
        }

    var showBookReview: Boolean
        get() = appCtx.getPrefBoolean(PreferKey.showBookReview, false)
        set(value) {
            appCtx.putPrefBoolean(PreferKey.showBookReview, value)
        }

    var bookReviewLines: Int
        get() = appCtx.getPrefInt(PreferKey.bookReviewLines, 3)
        set(value) {
            appCtx.putPrefInt(PreferKey.bookReviewLines, value.coerceIn(0, 10))
        }

    var bookIntroLines: Int
        get() = appCtx.getPrefInt(PreferKey.bookIntroLines, 3)
        set(value) {
            appCtx.putPrefInt(PreferKey.bookIntroLines, value.coerceIn(0, 10))
        }
    ...
    var onlyShowReadingMemoryWithReview: Boolean
        get() = appCtx.getPrefBoolean(PreferKey.onlyShowReadingMemoryWithReview, false)
        set(value) {
            appCtx.putPrefBoolean(PreferKey.onlyShowReadingMemoryWithReview, value)
        }
