...
class BookshelfFragment1() : BaseBookshelfFragment(R.layout.fragment_bookshelf1),
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu) {
        ...
        for (i in 0 until menu.size()) {
            menu.getItem(i).icon?.setTint(io.legado.app.lib.theme.ThemeStore.titleBarTextIconColor(requireContext()))
        }
    }
    ...
    override fun upGroup(data: List<BookGroup>) {
        if (data.isEmpty()) {
            ...
            if (data != bookGroups) {
                ...
                selectLastTab()
                val textColor = ThemeStore.textColorSecondary(requireContext())
                val selectedColor = ThemeStore.titleBarTextIconColor(requireContext())
                tabLayout.setTabTextColors(textColor, selectedColor)
    ...
    private inner class TabFragmentPageAdapter(fm: FragmentManager) :
        ...
        override fun getItemPosition(any: Any): Int {
            ...
            fragment.setFilterOnlyText(group.filterOnlyText)
