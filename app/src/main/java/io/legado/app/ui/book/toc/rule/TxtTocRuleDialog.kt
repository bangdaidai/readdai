...
class TxtTocRuleDialog() : BaseDialogFragment(R.layout.dialog_toc_regex),
    ...
    override fun onStart() {
        super.onStart()
        setLayout(ViewGroup.LayoutParams.MATCH_PARENT, 0.8f) // 保留高度设置
    }
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 设置加号图标为标题栏文字图标颜色
        binding.toolBar.menu.findItem(R.id.menu_add)?.icon?.setTint(io.legado.app.lib.theme.ThemeStore.titleBarTextIconColor(requireContext()))
