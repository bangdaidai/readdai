...
class ExploreShowActivity : VMBaseActivity<ActivityExploreShowBinding, ExploreShowViewModel>(),
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.pageLiveData.observe(this) { page ->
            menuPage?.let {
                val spannableString = android.text.SpannableString(getString(R.string.menu_page, page))
                val tintColor = io.legado.app.utils.MenuExtensions.getMenuColor(this)
    ...
    override fun onCompatCreateOptionsMenu(menu: android.view.Menu): Boolean {
        menu.applyTint(this)
        menuPage = menu.add(getString(R.string.menu_page, 1)).apply {
