...
//            }
                ...
                TextColumn(
                    ...
                    charData = char,
                    highlightColor = highlightInfo?.color,
                    highlightStyle = highlightInfo?.style
                )
            }
        }
    ...
    data class HighlightInfo(
        val color: Int? = null,
        val style: HighlightStyleSpan? = null
    )

    private fun getHighlightInfo(char: String, isTitle: Boolean): HighlightInfo? {
