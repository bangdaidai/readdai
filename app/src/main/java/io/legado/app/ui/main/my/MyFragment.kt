    ...
    class MyPreferenceFragment : PreferenceFragment(),
        ...
        override fun onPreferenceTreeClick(preference: Preference): Boolean {
            when (preference.key) {
                ...
                "bookTagManage" -> {
                    val intent = Intent(requireContext(), BookTagManageActivity::class.java)
                    startActivity(intent)
                }
                "vectorBooks" -> startActivity<VectorBooksActivity>()
                "annotation" -> startActivity<AllAnnotationActivity>()
                "readingMemory" -> startActivity<ReadingMemoryActivity>()
                ...
                "aiSettings" -> startActivity<ConfigActivity> {
