...
class TocActivity : VMBaseActivity<ActivityChapterListBinding, TocViewModel>(),
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        // 设置TabLayout文字颜色为标题栏文字图标颜色
        val titleBarTextColor = io.legado.app.lib.theme.ThemeStore.titleBarTextIconColor(this)
        tabLayout.setTabTextColors(titleBarTextColor, titleBarTextColor)
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        ...
        searchView = (search.actionView as SearchView).apply {
            applyTint(io.legado.app.lib.theme.ThemeStore.titleBarTextIconColor(this@TocActivity))
    ...
    override fun onCompatOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.menu_replace_rule -> {
                startActivity(Intent(this, io.legado.app.ui.replace.ReplaceRuleActivity::class.java))
            }
