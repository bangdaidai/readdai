...
class BookSourceEditActivity :
    ...
    override fun onCompatCreateOptionsMenu(menu: Menu): Boolean {
        ...
        for (i in 0 until menu.size()) {
            ...
            item.icon?.setTint(io.legado.app.lib.theme.ThemeStore.titleBarTextIconColor(this))
        }
    ...
    private fun initView() {
        ...
        // 设置标签文字颜色，选中和未选中状态保持一致
        binding.tabLayout.setTabTextColors(getColor(R.color.textPrimary), getColor(R.color.textPrimary))
